...
const CASES = [
  { id: 'star', name: 'Star Case', icon: '⭐', img: '/img/cases/star.png', price: 1, color: '#eab308',
    items: [
      { name: 'Heart', emoji: '❤️', value: 15, rarity: 'common', chance: 55 },
      { name: 'Rose', emoji: '🌹', value: 20, rarity: 'common', chance: 25 },
      { name: 'Clover', emoji: '🍀', value: 25, rarity: 'common', chance: 12 },
      { name: 'Cookie', emoji: '🍪', value: 30, rarity: 'uncommon', chance: 5 },
      { name: 'Sakura', emoji: '🌸', value: 35, rarity: 'uncommon', chance: 2.5 },
      { name: 'Snoop Dogg', emoji: '🐕', value: 40, rarity: 'rare', chance: 0.4 },
      { name: 'Toy Bear', emoji: '🧸', value: 50, rarity: 'epic', chance: 0.08 },
      { name: 'Swiss Watch', emoji: '⌚', value: 75, rarity: 'legendary', chance: 0.02 },
    ]
  },
  { id: 'summer', name: 'Super Summer', icon: '☀️', img: '/img/cases/summer.png', price: 5, color: '#f97316',
    items: [
      { name: 'Heart', emoji: '❤️', value: 15, rarity: 'common', chance: 35 },
      { name: 'Rose', emoji: '🌹', value: 20, rarity: 'common', chance: 22 },
      { name: 'Clover', emoji: '🍀', value: 25, rarity: 'common', chance: 15 },
      { name: 'Cookie', emoji: '🍪', value: 30, rarity: 'common', chance: 10 },
      { name: 'Flame', emoji: '🔥', value: 35, rarity: 'uncommon', chance: 7 },
      { name: 'Sakura', emoji: '🌸', value: 40, rarity: 'uncommon', chance: 5 },
      { name: 'Snoop Dogg', emoji: '🐕', value: 50, rarity: 'rare', chance: 3.5 },
      { name: 'Toy Bear', emoji: '🧸', value: 60, rarity: 'rare', chance: 1.8 },
      { name: 'Astral Shard', emoji: '🜮', value: 75, rarity: 'epic', chance: 0.5 },
      { name: 'Swiss Watch', emoji: '⌚', value: 90, rarity: 'legendary', chance: 0.15 },
      { name: 'Loot Bag', emoji: '🎒', value: 100, rarity: 'legendary', chance: 0.05 },
    ]
  },
  { id: 'rgb', name: 'RGB Capsule', icon: '🌈', img: '/img/cases/rgb.png', price: 8, color: '#8b5cf6',
    items: [
      { name: 'Heart', emoji: '❤️', value: 15, rarity: 'common', chance: 28 },
      { name: 'Rose', emoji: '🌹', value: 20, rarity: 'common', chance: 20 },
      { name: 'Clover', emoji: '🍀', value: 25, rarity: 'common', chance: 15 },
      { name: 'Flame', emoji: '🔥', value: 35, rarity: 'uncommon', chance: 12 },
      { name: 'Sakura', emoji: '🌸', value: 40, rarity: 'uncommon', chance: 9 },
      { name: 'Snoop Dogg', emoji: '🐕', value: 50, rarity: 'uncommon', chance: 6 },
      { name: 'Toy Bear', emoji: '🧸', value: 60, rarity: 'rare', chance: 4.5 },
      { name: 'Astral Shard', emoji: '🜮', value: 75, rarity: 'rare', chance: 3 },
      { name: 'Swiss Watch', emoji: '⌚', value: 90, rarity: 'epic', chance: 1.5 },
      { name: 'Loot Bag', emoji: '🎒', value: 100, rarity: 'epic', chance: 0.7 },
      { name: 'Heroic Helmet', emoji: '⛑️', value: 120, rarity: 'legendary', chance: 0.2 },
      { name: 'Scared Cat', emoji: '😺', value: 150, rarity: 'legendary', chance: 0.08 },
    ]
  },
  { id: 'regular', name: 'Regular Case', icon: '📦', img: '/img/cases/regular.png', price: 12, color: '#6366f1',
    items: [
      { name: 'Heart', emoji: '❤️', value: 15, rarity: 'common', chance: 22 },
      { name: 'Clover', emoji: '🍀', value: 25, rarity: 'common', chance: 18 },
      { name: 'Cookie', emoji: '🍪', value: 30, rarity: 'common', chance: 14 },
      { name: 'Flame', emoji: '🔥', value: 35, rarity: 'common', chance: 12 },
      { name: 'Sakura', emoji: '🌸', value: 40, rarity: 'uncommon', chance: 9 },
      { name: 'Snoop Dogg', emoji: '🐕', value: 50, rarity: 'uncommon', chance: 7 },
      { name: 'Toy Bear', emoji: '🧸', value: 60, rarity: 'uncommon', chance: 5.5 },
      { name: 'Astral Shard', emoji: '🜮', value: 75, rarity: 'rare', chance: 4 },
      { name: 'Swiss Watch', emoji: '⌚', value: 90, rarity: 'rare', chance: 3 },
      { name: 'Loot Bag', emoji: '🎒', value: 100, rarity: 'epic', chance: 2 },
      { name: 'Heroic Helmet', emoji: '⛑️', value: 120, rarity: 'epic', chance: 1.2 },
      { name: 'Scared Cat', emoji: '😺', value: 150, rarity: 'legendary', chance: 0.25 },
      { name: 'Precious Peach', emoji: '🍑', value: 180, rarity: 'legendary', chance: 0.05 },
    ]
  },
  { id: 'farm', name: 'Farm Case', icon: '🌾', img: '/img/cases/farm.png', price: 15, color: '#22c55e',
    items: [
      { name: 'Rose', emoji: '🌹', value: 20, rarity: 'common', chance: 20 },
      { name: 'Clover', emoji: '🍀', value: 25, rarity: 'common', chance: 18 },
      { name: 'Cookie', emoji: '🍪', value: 30, rarity: 'common', chance: 15 },
      { name: 'Flame', emoji: '🔥', value: 35, rarity: 'uncommon', chance: 12 },
      { name: 'Sakura', emoji: '🌸', value: 40, rarity: 'uncommon', chance: 10 },
      { name: 'Snoop Dogg', emoji: '🐕', value: 50, rarity: 'uncommon', chance: 8 },
      { name: 'Toy Bear', emoji: '🧸', value: 60, rarity: 'rare', chance: 5.5 },
      { name: 'Astral Shard', emoji: '🜮', value: 75, rarity: 'rare', chance: 4.5 },
      { name: 'Swiss Watch', emoji: '⌚', value: 90, rarity: 'epic', chance: 3 },
      { name: 'Loot Bag', emoji: '🎒', value: 100, rarity: 'epic', chance: 2 },
      { name: 'Heroic Helmet', emoji: '⛑️', value: 120, rarity: 'rare', chance: 1.2 },
      { name: 'Scared Cat', emoji: '😺', value: 150, rarity: 'epic', chance: 0.6 },
      { name: 'Precious Peach', emoji: '🍑', value: 180, rarity: 'legendary', chance: 0.15 },
      { name: 'Durov\'s Cap', emoji: '🧢', value: 220, rarity: 'legendary', chance: 0.04 },
    ]
  },
  { id: 'flex', name: 'Flex Case', icon: '😎', img: '/img/cases/flex.png', price: 25, color: '#ec4899',
    items: [
      { name: 'Heart', emoji: '❤️', value: 15, rarity: 'common', chance: 15 },
      { name: 'Cookie', emoji: '🍪', value: 30, rarity: 'common', chance: 14 },
      { name: 'Flame', emoji: '🔥', value: 35, rarity: 'common', chance: 12 },
      { name: 'Sakura', emoji: '🌸', value: 40, rarity: 'uncommon', chance: 10 },
      { name: 'Snoop Dogg', emoji: '🐕', value: 50, rarity: 'uncommon', chance: 9 },
      { name: 'Toy Bear', emoji: '🧸', value: 60, rarity: 'uncommon', chance: 8 },
      { name: 'Astral Shard', emoji: '🜮', value: 75, rarity: 'rare', chance: 7 },
      { name: 'Swiss Watch', emoji: '⌚', value: 90, rarity: 'rare', chance: 6 },
      { name: 'Loot Bag', emoji: '🎒', value: 100, rarity: 'rare', chance: 5 },
      { name: 'Heroic Helmet', emoji: '⛑️', value: 120, rarity: 'epic', chance: 4.5 },
      { name: 'Scared Cat', emoji: '😺', value: 150, rarity: 'epic', chance: 4 },
      { name: 'Precious Peach', emoji: '🍑', value: 180, rarity: 'rare', chance: 2.5 },
      { name: 'Durov\'s Cap', emoji: '🧢', value: 220, rarity: 'epic', chance: 1.5 },
      { name: 'Heart Locket', emoji: '💝', value: 300, rarity: 'legendary', chance: 0.8 },
      { name: 'Plush Pepe', emoji: '🐸', value: 400, rarity: 'legendary', chance: 0.15 },
      { name: 'Plush Pepe', emoji: '🐸', value: 600, rarity: 'legendary', chance: 0.05 },
    ]
  },
  { id: 'vision', name: 'Vision Case', icon: '🜮', img: '/img/cases/vision.png', price: 35, color: '#06b6d4',
    items: [
      { name: 'Clover', emoji: '🍀', value: 25, rarity: 'common', chance: 14 },
      { name: 'Cookie', emoji: '🍪', value: 30, rarity: 'common', chance: 12 },
      { name: 'Sakura', emoji: '🌸', value: 40, rarity: 'common', chance: 11 },
      { name: 'Snoop Dogg', emoji: '🐕', value: 50, rarity: 'uncommon', chance: 10 },
      { name: 'Toy Bear', emoji: '🧸', value: 60, rarity: 'uncommon', chance: 9 },
      { name: 'Astral Shard', emoji: '🜮', value: 75, rarity: 'uncommon', chance: 8 },
      { name: 'Swiss Watch', emoji: '⌚', value: 90, rarity: 'rare', chance: 7 },
      { name: 'Loot Bag', emoji: '🎒', value: 100, rarity: 'rare', chance: 6 },
      { name: 'Heroic Helmet', emoji: '⛑️', value: 120, rarity: 'rare', chance: 6 },
      { name: 'Scared Cat', emoji: '😺', value: 150, rarity: 'epic', chance: 5.5 },
      { name: 'Precious Peach', emoji: '🍑', value: 180, rarity: 'epic', chance: 5 },
      { name: 'Durov\'s Cap', emoji: '🧢', value: 220, rarity: 'rare', chance: 3 },
      { name: 'Heart Locket', emoji: '💝', value: 300, rarity: 'epic', chance: 2 },
      { name: 'Plush Pepe', emoji: '🐸', value: 450, rarity: 'legendary', chance: 1 },
      { name: 'Heart Locket', emoji: '💝', value: 500, rarity: 'legendary', chance: 0.4 },
      { name: 'Plush Pepe', emoji: '🐸', value: 600, rarity: 'legendary', chance: 0.1 },
    ]
  },
  { id: 'fresh', name: 'Fresh Case', icon: '🍃', img: '/img/cases/fresh.png', price: 50, color: '#10b981',
    items: [
      { name: 'Cookie', emoji: '🍪', value: 30, rarity: 'common', chance: 12 },
      { name: 'Flame', emoji: '🔥', value: 35, rarity: 'common', chance: 11 },
      { name: 'Sakura', emoji: '🌸', value: 40, rarity: 'common', chance: 10 },
      { name: 'Snoop Dogg', emoji: '🐕', value: 50, rarity: 'uncommon', chance: 9 },
      { name: 'Toy Bear', emoji: '🧸', value: 60, rarity: 'uncommon', chance: 8 },
      { name: 'Astral Shard', emoji: '🜮', value: 75, rarity: 'uncommon', chance: 8 },
      { name: 'Swiss Watch', emoji: '⌚', value: 90, rarity: 'rare', chance: 7.5 },
      { name: 'Loot Bag', emoji: '🎒', value: 100, rarity: 'rare', chance: 7 },
      { name: 'Heroic Helmet', emoji: '⛑️', value: 120, rarity: 'rare', chance: 7 },
      { name: 'Scared Cat', emoji: '😺', value: 150, rarity: 'epic', chance: 6.5 },
      { name: 'Precious Peach', emoji: '🍑', value: 180, rarity: 'epic', chance: 5.5 },
      { name: 'Durov\'s Cap', emoji: '🧢', value: 220, rarity: 'rare', chance: 4 },
      { name: 'Heart Locket', emoji: '💝', value: 300, rarity: 'epic', chance: 3 },
      { name: 'Plush Pepe', emoji: '🐸', value: 450, rarity: 'legendary', chance: 1.5 },
      { name: 'Heart Locket', emoji: '💝', value: 500, rarity: 'legendary', chance: 0.8 },
      { name: 'Plush Pepe', emoji: '🐸', value: 600, rarity: 'legendary', chance: 0.2 },
    ]
  },
];
...
const UPGRADE_TABLE = {
  ...
  100: { multiplier: 2.5, chance: 40 },
  150: { multiplier: 2.5, chance: 40 },
  200: { multiplier: 3, chance: 33 },
  300: { multiplier: 3, chance: 33 },
  400: { multiplier: 3, chance: 30 },
};
